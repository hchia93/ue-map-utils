#include "Operations/AuditLevelReferenceCommandlet.h"
...
bool UAuditLevelReferenceCommandlet::ParseOptions(const FString& Params, FOptions& OutOptions) const
{
    FString LevelsValue;
    ...
    if (!FParse::Value(*Params, TEXT("-report="), OutOptions.ReportPath, false) || OutOptions.ReportPath.IsEmpty())
    {
        ...
        OutOptions.ReportPath = FPaths::Combine(FPaths::ProjectDir(), TEXT("Intermediate"), TEXT("AuditLevelReference"), FString::Printf(TEXT("%s.json"), *Stamp));
    }
...
void UAuditLevelReferenceCommandlet::CollectMapPackages(const FOptions& Options, IAssetRegistry& AssetRegistry, TArray<FName>& OutMapPackages) const
{
...
void UAuditLevelReferenceCommandlet::AuditMap(FName MapPackage, IAssetRegistry& AssetRegistry, FMapResult& OutResult) const
{
...
bool UAuditLevelReferenceCommandlet::WriteReport(const FString& ReportPath, const TArray<FMapResult>& Results, int32 MapsScanned) const
{
