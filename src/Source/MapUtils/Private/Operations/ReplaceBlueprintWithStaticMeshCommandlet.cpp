#include "Operations/ReplaceBlueprintWithStaticMeshCommandlet.h"
...
UReplaceBlueprintWithStaticMeshCommandlet::UReplaceBlueprintWithStaticMeshCommandlet()
{
    IsClient = false;
    IsEditor = true;
    IsServer = false;
...
int32 UReplaceBlueprintWithStaticMeshCommandlet::Main(const FString& Params)
{
...
bool UReplaceBlueprintWithStaticMeshCommandlet::ParseOptions(const FString& Params, FOptions& OutOptions) const
{
...
bool UReplaceBlueprintWithStaticMeshCommandlet::ResolveCandidateClasses(const TArray<FString>& CandidateAssetPaths, TArray<UClass*>& OutClasses) const
{
    OutClasses.Reset();
...
bool UReplaceBlueprintWithStaticMeshCommandlet::ProcessLevel(const FString& LevelPath, const TArray<UClass*>& CandidateClasses, bool bDryRun, FLevelResult& OutResult) const
{
...
bool UReplaceBlueprintWithStaticMeshCommandlet::ReplaceInstance(AActor* OldActor, UWorld* World, UClass* MatchedClass, bool bDryRun, FReplaceRecord& OutRecord) const
{
...
bool UReplaceBlueprintWithStaticMeshCommandlet::WriteManifest(const FString& ManifestPath, const TArray<FLevelResult>& LevelResults, bool bDryRun) const
{
