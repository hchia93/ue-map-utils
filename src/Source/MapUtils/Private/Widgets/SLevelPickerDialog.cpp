...
#define LOCTEXT_NAMESPACE "SLevelPickerDialog"

void SLevelPickerDialog::Construct(const FArguments& InArgs)
{
    World = InArgs._World;
    ...
    [
        ...
        [
            ...
            [
                ...
                .OnGenerateRow(this, &SLevelPickerDialog::OnGenerateRow)
                .OnSelectionChanged(this, &SLevelPickerDialog::OnSelectionChanged)
            ]
            ...
            [
                ...
                [
                    ...
                    .IsEnabled(this, &SLevelPickerDialog::IsConfirmEnabled)
                    .OnClicked(this, &SLevelPickerDialog::OnConfirmClicked)
                ]
                ...
                [
                    ...
                    .OnClicked(this, &SLevelPickerDialog::OnCancelClicked)
                ]
            ]
        ]
    ];
...
TSharedRef<ITableRow> SLevelPickerDialog::OnGenerateRow(TSharedPtr<FLevelItem> Item, const TSharedRef<STableViewBase>& OwnerTable)
{
...
void SLevelPickerDialog::OnSelectionChanged(TSharedPtr<FLevelItem> Item, ESelectInfo::Type /*SelectInfo*/)
{
    if (Item.IsValid())
    {
...
FReply SLevelPickerDialog::OnConfirmClicked()
{
...
FReply SLevelPickerDialog::OnCancelClicked()
{
    PickedLevel = nullptr;
    if (TSharedPtr<SWindow> Window = ParentWindow.Pin())
    {
...
bool SLevelPickerDialog::IsConfirmEnabled() const
{
    return PickedLevel.IsValid();
}

ULevel* SLevelPickerDialog::OpenModal(UWorld* WorldPtr, TSharedPtr<SWindow> RootWindow)
{
    ...
    TSharedPtr<SLevelPickerDialog> Dialog;
    Window->SetContent(
        SAssignNew(Dialog, SLevelPickerDialog)
        .World(WorldPtr)
        .ParentWindow(Window)
    );
