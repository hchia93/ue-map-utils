...
#define LOCTEXT_NAMESPACE "SActorChangeDialog"

namespace
{
    TSharedRef<SWidget> BuildObjectSection(const FObjectChange& Change)
    {
...
void SActorChangeDialog::Construct(const FArguments& InArgs)
{
    ...
    {
        for (const FObjectChange& Change : Summary.Objects)
        {
        ...
        [
            ...
            [
                ...
                [
                    ...
                    .OnClicked(this, &SActorChangeDialog::OnCloseClicked)
                ]
            ]
        ]
    ];
...
FReply SActorChangeDialog::OnCloseClicked()
{
...
TSharedRef<SWindow> SActorChangeDialog::OpenWindow(AActor* Actor)
{
    FText Title;
    if (Actor)
    {
    ...
    TSharedPtr<SActorChangeDialog> Dialog;
    Window->SetContent(
        SAssignNew(Dialog, SActorChangeDialog)
        .Actor(Actor)
        .ParentWindow(Window)
    );
