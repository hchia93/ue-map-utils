 ...
 */
class SLevelDiffDialog : public SCompoundWidget
{
public:
    SLATE_BEGIN_ARGS(SLevelDiffDialog) {}
...
private:
    ...
    TSharedRef<ITableRow> OnGenerateRow(TSharedPtr<FDiffRow> Row, const TSharedRef<STableViewBase>& OwnerTable);
    ...
    TArray<TSharedPtr<FDiffRow>> Rows;
    TSharedPtr<SListView<TSharedPtr<FDiffRow>>> ListView;
};
