...
#include "ReplaceBlueprintWithStaticMeshCommandlet.generated.h"
 ...
 *
 * Usage:
 *   UnrealEditor-Cmd.exe Project.uproject -run=ReplaceBlueprintWithStaticMesh
 ...
 */
UCLASS()
class UReplaceBlueprintWithStaticMeshCommandlet : public UCommandlet
{
    GENERATED_BODY()

public:

    UReplaceBlueprintWithStaticMeshCommandlet();
