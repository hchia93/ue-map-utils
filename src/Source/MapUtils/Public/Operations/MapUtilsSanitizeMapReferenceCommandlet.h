...
#include "MapUtilsSanitizeMapReferenceCommandlet.generated.h"
 ...
 *
 * Usage:
 *   UnrealEditor-Cmd.exe Project.uproject -run=MapUtilsSanitizeMapReference
 ...
 *   -report=   Where to write the report JSON. Defaults under Intermediate/MapUtilsSanitizeMapReference/.
 ...
 */
UCLASS()
class UMapUtilsSanitizeMapReferenceCommandlet : public UCommandlet
{
    GENERATED_BODY()

public:

    UMapUtilsSanitizeMapReferenceCommandlet();
